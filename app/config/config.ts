...
const ConfigSchema = Type.Strict(
    Type.Object({
        ...
        GOOGLE_ACCESS_REDIRECT_URI: Type.String(),
    })
);
const ajv = new Ajv({
    allErrors: true,
...
export const configData: Config = {
    ...
    GOOGLE_CLIENT_ID: filteredEnv.GOOGLE_CLIENT_ID,
    GOOGLE_PROJECT_ID: filteredEnv.GOOGLE_PROJECT_ID,
    GOOGLE_CLIENT_SECRET: filteredEnv.GOOGLE_CLIENT_SECRET,
    GOOGLE_REDIRECT_URI: filteredEnv.GOOGLE_REDIRECT_URI,
    GOOGLE_ACCESS_REDIRECT_URI: filteredEnv.GOOGLE_ACCESS_REDIRECT_URI,
};
